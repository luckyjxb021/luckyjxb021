...
<td width="16%" align="right">
      <a href="#" onClick="window.open('bookcase_add.jsp','','width=452,height=175')">添加书架信息</a> </td>	  
  </tr>
</table>  
...
<%
  ...
  <tr>
    ...
    <td align="center"><a href="#" onClick="window.open('bookCase?action=bookCaseModifyQuery&ID=<%=ID%>','','width=452,height=175')">修改</a></td>
