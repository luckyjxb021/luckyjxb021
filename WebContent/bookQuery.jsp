...
<table width="778"  border="0" cellspacing="0" cellpadding="0" align="center">
 ...
 <table width="98%" height="38"  border="0" cellpadding="0" cellspacing="0" bgcolor="#E3F4F7" class="tableBorder_gray">
  <tr>
    <td align="center" bgcolor="#F9D16B">&nbsp;<img src="Images/search.gif" width="45" height="28"></td>
...
%>
  ...
  int storage=0;
  %>  
  <table width="98%"  border="1" cellpadding="0" cellspacing="0" class="table" style="margin-top:8px;">
