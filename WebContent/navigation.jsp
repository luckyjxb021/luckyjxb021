...
//在Eclipse中，下面一行代码的manager下方会有红色的波浪线，不用理会，manager变量是在包括navigation.jsp文件的页面中定义的
...
<script  type="text/javascript" src="JS/onclock.JS" charset=utf-8></script>
