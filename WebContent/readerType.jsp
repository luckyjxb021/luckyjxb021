...
%>
  ...
  <tr>
    <td>
      <a href="#" onClick="window.open('readerType_add.jsp','','width=452,height=175')">添加读者类型信息</a> </td>
  </tr>
</table>
 <%
}else{
 ...
 <table width="91%"  border="0" cellspacing="0" cellpadding="0">
  ...
  <table width="91%"  border="1" cellpadding="0" cellspacing="0" class="table">
...
<%
  ...
  <tr>
    ...
    <td align="center"><a href="#" onClick="window.open('readerType?action=readerTypeModifyQuery&ID=<%=ID%>','','width=452,height=175')">修改</a></td>
