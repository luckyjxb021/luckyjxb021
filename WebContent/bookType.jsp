...
%>
  ...
  <tr>
    <td>
      <a href="#" onClick="window.open('bookType_add.jsp','','width=452,height=175')">添加图书类型信息</a> </td>
  </tr>
</table>
 <%
}else{
...
<td width="18%" align="right">
      <a href="#" onClick="window.open('bookType_add.jsp','','width=452,height=180')">添加图书类型信息</a> </td>	  
  </tr>
</table>  
