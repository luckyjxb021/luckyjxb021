...
%>
  ...
  <tr>
    <td>
      <a href="#" onClick="window.open('manager_add.jsp','','width=452,height=175')">添加管理员信息</a> </td>
  </tr>
</table>
 <%
}else{
 ...
 <table width="100%"  border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="84%">&nbsp;      </td>
<td width="16%">
      <a href="#" onClick="window.open('manager_add.jsp','','width=452,height=180')">添加管理员信息</a> </td>	  
  </tr>
</table>  
